...
class Collect(object):
    ...
    Args:
        ...
        meta_keys (Sequence[str], optional): Meta keys to be converted to
            ...
            Default: ``('filename', 'ori_filename', 'ori_img_shape', 'img_shape',
             'scale_factor', 'flip', 'flip_direction', 'img_norm_cfg')``
    """

    def __init__(self,
                 keys,
                 meta_keys=('filename', 'ori_filename', 'ori_img_shape',
                            'img_shape', 'scale_factor', 'pad', 'flip',
